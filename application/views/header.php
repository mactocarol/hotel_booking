...
<html lang="en">
  <head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
     <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGZmMn1zYGSmmgRx_4PcJMzEl7JxByy4A&libraries=places"></script>
  </head>
	...
	<div class="container">
    	<div class="col-md-6">
        	<ul class="pull-left social_icon">
                ...
                <li><i class="fa fa-envelope"> </i><a href="#"> contact@gmail.coms</a></li>
            </ul>
        </div>
        <div class="col-md-6">
        	<ul class="pull-right">
                ...
                <li>
                  ...
                  <?php
                    ...
                    ?>
                    <li><a href="<?= base_url('myaccounts'); ?>"><?php echo $this->lang->line('My account'); ?></a></li>
                    <?php endif; ?>
                    <?php
                        if(!$this->session->userdata('is_logged_in')):
                    ?>
                    <li><a href="<?= base_url('user_login');?>"><?php echo $this->lang->line('login'); ?></a>
                    <?php endif; ?>   
                    <?php
                        if($this->session->userdata('is_logged_in')):
                    ?>   
                    <li><a href="<?= base_url('user_login/logout'); ?>"><?php echo $this->lang->line('Logout'); ?></a></li></li>
                    <?php endif; ?>
            </ul>
        </div>
