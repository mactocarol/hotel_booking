...
class Hotel extends HT_Controller 
{
	//private $connection;
        ...
        public function list_hotel(){
            ...
            $config = array();
            $config["base_url"] =  base_url()."hotel/list_hotel";
            ...
            /*$place1= 'hb_hotel_images.id';
            $place2= 'hb_hotels.id';
            $WhereData=array();
            $Selectdata='hb_hotels.id,hb_hotels.name,hb_hotels.description,hb_hotels.logo,hb_hotels.city,hb_hotel_images.image';
            $TableName1='hb_hotels';
            $TableName2='hb_hotel_images';
            $orderby= 'hb_hotels.id ASC';
            $limit=$config["per_page"];
            $start=$pageno;
            $data=new stdClass();
            $data->results = $this->hotel_model->joindatapagination($place1,$place2,$WhereData,$Selectdata,$TableName1,$TableName2,$orderby,$limit,$start);*/
            //select data with join end//
            // select data without join//
            $TableName='hb_hotels';
